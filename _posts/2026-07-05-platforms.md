...
description: "Choose where to run Claude Code and what to connect it to. Compare the CLI, Desktop, VS Code, JetBrains, web, mobile, and integrations like Chrome, Slack, and C"
---
...
Source: https://code.claude.com/docs/en/plugin-dependencie