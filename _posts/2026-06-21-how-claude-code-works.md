...
<img alt="Diagram of the agentic loop: Your prompt leads to Claude gathering context, taking action, verifying results, and repeating until task complete. You can interrupt at any point." />
...
<img alt="Diagram of session continuity: resume continues the same session, fork creates a new branch with a new ID." />
...
# Interactive mode
Source: https://code.claude.com/docs/en/interactive-mod